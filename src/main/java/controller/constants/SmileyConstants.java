...
public class SmileyConstants {
    ...
    public static final double screenHeight = MainFrame.getINSTANCE().getHeight(); // Example screen height in pixels
    ...
    public static final double restitution = 0.8; // Coefficient of restitution (bounciness)
    public static final double bounceHeightFactor = 0.6; // Factor of the height to bounce back up
