...
public enum EntityConstants {
    ...
    TRIGORATH_NUM_OF_COLLECTIBLES, TRIGORATH_COLLECTIBLES_XP,
    SQUARANTINE_NUM_OF_COLLECTIBLES, SQUARANTINE_COLLECTIBLES_XP,
    ...
    SMILEY_PROJECTILE_COOLDOWN, SMILEY_SLAP_COOLDOWN, SMILEY_SQUEEZE_COOLDOWN, SMILEY_SQUEEZE_DURATION, SMILEY_PROJECTILE_DURATION,
    SMILEY_SLAP_DURATION, COLLECTABLE_RADIUS, WYRM_MIN_DISTANCE, WYRM_MAX_DISTANCE;
    ...
    public int getValue() {
        return switch (this) {
            case EPSILON_SHOOTING_RAPIDITY -> 1;
            ...
            case TRIGORATH_NUM_OF_COLLECTIBLES -> 2;
            case TRIGORATH_COLLECTIBLES_XP -> 5;
            ...
            case COLLECTABLE_RADIUS -> 5;
            case WYRM_MIN_DISTANCE -> 300;
            case WYRM_MAX_DISTANCE -> 600;
        };
    }
